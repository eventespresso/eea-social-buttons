	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo EEH_Form_Fields::select( __('Show Social Buttons in the single event page?', 'event_espresso'), 0, $yes_no_values, 'social_buttons[show_social_buttons_single_event_page]', 'show_social_buttons_single_event_page' ); ?><br/>
					<span class="description">
			...
			<tr>
				...
				<td>
					<?php echo EEH_Form_Fields::select( __('Show Social Buttons in the registration confirmation/thank you page?', 'event_espresso'), 0, $yes_no_values, 'social_buttons[show_social_buttons_confirmation_page]', 'show_social_buttons_confirmation_page' ); ?><br/>
					<span class="description">
